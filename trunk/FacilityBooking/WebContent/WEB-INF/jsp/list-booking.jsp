...
<jsp:include page="menu.jsp"></jsp:include>
     	 <display:table name="roomList" requestURI="/list-booking.do" 
      				id="room" uid="room"  excludedParams="*"    
      				class="displaytag" cellpadding="0" style="width:800px" pagesize="20">
           		<display:column title="Rooms"><a href="list-bookedRoom.do?id=${room.roomId}">${room.roomName}</a></display:column>
           </display:table>
</div>
</body>
</html>